...
<!--banner开始-->
<div class="f-banner">
    <img class="f-banner-bg" src="/web/image/cpjs-banner.jpg"/>
    <div class="bx">
        <img class="f-banner-text f-cpjs-text wow zoomIn animated" src="/web/image/cpjs-banner-text.png"/>
    </div>
</div>
<!--banner结束-->
...
<!--内容开始-->
<div class="cpjs-cont">
    <img src="/web/image/cpjs-title.png"/>
    <ul class="cpjs-list">
        <?php foreach ($model
    ...
    <footer>
        <div class="footer">
            <div class="footer-x-bg wow fadeInDown animated">
                <img src="/web/image/cpjs-btm-tit.png"/>
            </div>
            <ul>
                <li>
