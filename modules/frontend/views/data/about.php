...
<html>
    ...
    <!--banner开始-->
	<div class="f-banner">
		<img class="f-banner-bg" src="/web/image/about-banner.jpg"/>
		<div class="bx">
			<img class="f-banner-text f-about-text wow zoomIn animated" src="/web/image/about-banner-text.png"/>
		</div>
	</div>
	<!--banner结束-->
	...
	<div class="about-cont">
		<div class="about-bx">
			<div class="about-js wow fadeInLeft animated">
				<img src="/web/image/about-title01.png" />
				...
				<div>
					<img src="/web/image/about-img01.jpg" />
					<img src="/web/image/about-img02.jpg" />
				</div>
			</div>
			<div class="about-wh">
				<img src="/web/image/about-title02.png" />
				<div class="about-wh-cont">
					<img src="/web/image/about-img03.jpg" class="wow fadeInLeft animated"/>
					<ul class="wow fadeInRight animated">
						<li><img src="/web/image/about-ico01.png"/><p><span>定位</span>轻奢美容洗护，油质皮肤调理专家</p></li>
						<li><img src="/web/image/about-ico02.png"/><p><span>愿景</span>成为中国美容洗护产品和体验门店领跑者</p></li>
						<li><img src="/web/image/about-ico03.png"/><p><span>使命</span>为消费者解决油质困扰，为加盟商带去财富商机</p></li>
						<li><img src="/web/image/about-ico04.png"/><p><span>宗旨</span>坚持用最好的产品、最好的服务、最好的信誉， 为合作伙伴和消费者带来最好的效果</p></li>
					</ul>
				</div>
			</div>
			<div class="about-zz wow fadeInRight animated">
				<img src="/web/image/about-title03.png" />
				<p>用最舒适的环境让顾客宾至如归，用最好的态度和心情迎接每一位顾客，用自己的专业解决每一位顾客的问题和困扰......用服务赋予产品最大的价值！</p>
				<div>
					<img src="/web/image/about-img04.jpg" />
				</div>
			</div>
		</div>
	</div>
    ...
    <footer>
        <div class="footer">
        	<div class="footer-x-bg wow fadeInDown animated">
        		<img src="/web/image/about-btm-tit.png" />
        	</div>
        	<ul>
        		<li>
