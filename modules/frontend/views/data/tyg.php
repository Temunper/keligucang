...
<html>
    ...
    <!--banner开始-->
	<div class="f-banner">
		<img class="f-banner-bg" src="/web/image/tyg-banner.jpg"/>
		<div class="bx">
			<img class="f-banner-text f-tyg-text wow zoomIn animated" src="/web/image/tyg-banner-text.png"/>
		</div>
	</div>
	<!--banner结束-->
	...
	<div class="tyg-cont">
		<div class="tyg-bx">
			<div class="tyg-list1 wow zoomIn animated">
				<img src="/web/image/tyg-tit01.png" />
				<div>
					<img src="/web/image/tyg-img01.jpg" />
					<img src="/web/image/tyg-img02.jpg" />
					<img src="/web/image/tyg-img03.jpg" />
				</div>
			</div>
			<div class="tyg-list2">
				<img src="/web/image/tyg-tit02.png" />
				<div class="tyg-list2-cont wow fadeInLeft animated">
					<img src="/web/image/tyg-list01.jpg" />
					<ul>
						<li>01</li>
						<li>
							<h2>一流环境</h2>
				...
				<div class="tyg-list2-cont  tyg-list2-cont2 wow fadeInRight animated">
					<img src="/web/image/tyg-list02.jpg" />
					<ul >
						<li>02</li>
						<li>
							<h2>一流设备</h2>
				...
				<div class="tyg-list2-cont wow fadeInLeft animated">
					<img src="/web/image/tyg-list03.jpg" />
					<ul>
						<li>03</li>
						<li>
							<h2>一流服务</h2>
				...
				<div class="tyg-list2-cont tyg-list2-cont2 wow fadeInRight animated">
					<img src="/web/image/tyg-list04.jpg" />
					<ul >
						<li>04</li>
						<li>
							<h2>大众消费</h2>
    ...
    <footer>
        <div class="footer">
        	<div class="footer-x-bg wow fadeInDown animated">
        		<img src="/web/image/tyg-btm-tit.png" />
        	</div>
        	<ul>
        		<li>
